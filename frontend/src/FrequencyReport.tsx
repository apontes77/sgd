...
export default function FrequencyReport(){
 ...
 return <Stack spacing={3}>
  ...
  <PageHeader title="Relatórios de frequência" description="Consulte o histórico de encontros realizados e de dias em que o discipulado não ocorreu." eyebrow="Análises" />
  ...
  {dados&&dados.relatorios.length===0&&<Alert severity="info">Não há registros de frequência no seu escopo no período de {formatarData(dados.dataInicio)} a {formatarData(dados.dataFim)}.</Alert>}
