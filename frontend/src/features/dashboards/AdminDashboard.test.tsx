...
describe('painel administrativo', () => {
  ...
  it('aplica um novo período', async () => {
    ...
    await userEvent.type(screen.getByLabelText(/Data final/), '2026-04-30')
  ...
  it('mostra erro padronizado da API', async () => {
    vi.spyOn(globalThis, 'fetch').mockResolvedValue(
      new Response(JSON.stringify({ title: 'Período inválido', detail: 'O período máximo permitido é de 24 meses.' }), {
        status: 400,
