...
import { formatarMes, normalizarMeses } from '@/shared/dashboard-utils'

describe('componentes do histórico', () => {
  it('completa meses ausentes sem confundir com presença zero', () => {
    const meses = normalizarMeses('2026-01-10', '2026-03-20', [
      { referencia: '2026-02', presentes: 0, ausentes: 2, visitantes: 0, percentualPresenca: 0 },
    ])
