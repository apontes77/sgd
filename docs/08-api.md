...
- Um encontro é `REALIZADO` ou `CANCELADO`; `CANCELADO` é apresentado como “Não realizado”, exige justificativa e pode ser definido ou desfeito por `ADMIN` ou pelo `DISCIPULADOR` do próprio grupo.
