...
- Um discipulado padrão tem exatamente um discipulador, uma gerência e até dois co-líderes. Discipulado de formação (`emFormacao`) tem discipulador, não tem gerência nem co-líder.
