...
public class Discipulado {
  ...
  public User getDiscipulador() {
    return discipulador;
  }

  public Set<User> getCoLideres() {
    return Set.copyOf(coLideres);
  }
  ...
  private static String normalizarNome(String nome) {
    if (nome == null || nome.isBlank())
      throw new IllegalArgumentException("O nome do discipulado é obrigatório.");
    return nome.trim();
  }
