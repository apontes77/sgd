...
public class ApiExceptionHandler {
  ...
  private static String detalheCorpoInvalido(HttpMessageNotReadableException exception) {
    ...
    if (causa instanceof IllegalArgumentException illegal
  ...
  public ResponseEntity<Map<String, Object>> handleResponseStatus(
    ...
    return response(
        status, exception.getReason() == null ? status.getReasonPhrase() : exception.getReason());
  }
  ...
  public ResponseEntity<Map<String, Object>> handleIllegalArgument(
    ...
    return response(
        ...
        exception.getMessage() == null ? "Dados de entrada inválidos." : exception.getMessage());
  }
  ...
  public ResponseEntity<Map<String, Object>> handleInvalidOAuth(
      OAuthIdentityService.InvalidOAuthIdentityException exception) {
    return response(
        HttpStatus.UNAUTHORIZED,
        "A identidade externa não corresponde a um usuário ativo cadastrado.");
  }

  @ExceptionHandler(OAuthIdentityService.OAuthIdentityConflictException.class)
  public ResponseEntity<Map<String, Object>> handleOAuthConflict(
      OAuthIdentityService.OAuthIdentityConflictException exception) {
    return response(
        HttpStatus.CONFLICT, "O provedor externo já está vinculado a outra identidade.");
  }

  @ExceptionHandler(UserService.DuplicateEmailException.class)
  public ResponseEntity<Map<String, Object>> handleDuplicateEmail(
      UserService.DuplicateEmailException exception) {
    return response(HttpStatus.CONFLICT, "E-mail já cadastrado.");
  }

  @ExceptionHandler(UserService.UserNotFoundException.class)
  public ResponseEntity<Map<String, Object>> handleUserNotFound(
      UserService.UserNotFoundException exception) {
    return response(HttpStatus.NOT_FOUND, "Usuário não encontrado.");
  }

  @ExceptionHandler({
    GerenciaService.GerenciaNotFoundException.class,
    GerenciaService.UsuarioOrganizacionalNotFoundException.class,
    DiscipuladoService.DiscipuladoNotFoundException.class,
    DiscipuladoService.GerenciaNotFoundException.class,
    DiscipuladoService.UsuarioOrganizacionalNotFoundException.class
  })
  public ResponseEntity<Map<String, Object>> handleOrganizationalNotFound(
