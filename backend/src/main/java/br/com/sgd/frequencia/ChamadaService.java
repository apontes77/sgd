...
public class ChamadaService {
 ...
 @Transactional(readOnly=true) public int listarVisitantes(User ator,long encontroId){var e=encontros.encontro(encontroId);escopo.exigirLeitura(ator,e.getDiscipulado());return visitantes.findByEncontroId(encontroId).map(Visitante::getQuantidade).orElse(0);}
