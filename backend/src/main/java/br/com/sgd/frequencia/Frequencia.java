...
@Table(
    name = "frequencias",
    uniqueConstraints = @UniqueConstraint(columnNames = {"encontro_id", "adolescente_id"}))
public class Frequencia {
  ...
  @ManyToOne(fetch = FetchType.LAZY, optional = false)
  @JoinColumn(name = "adolescente_id")
  ...
  public Frequencia(
      Encontro encontro, Adolescente adolescente, SituacaoFrequencia situacao, Instant agora) {
    this.encontro = encontro;
    this.adolescente = adolescente;
    this.situacao = situacao;
    this.registradaEm = agora;
    this.atualizadaEm = agora;
  }

  public void atualizar(SituacaoFrequencia situacao, Instant agora) {
    this.situacao = situacao;
    this.atualizadaEm = agora;
  }
