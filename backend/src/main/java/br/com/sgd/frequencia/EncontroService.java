...
public class EncontroService {
 ...
 final EscopoOrganizacionalService escopoAcesso(){ return escopo; }
 ...
 List<br.com.sgd.adolescente.VinculoAdolescenteDiscipulado> elegiveis(Encontro e){return vinculos.elegiveis(e.getDiscipulado().getId(),e.getData());}
