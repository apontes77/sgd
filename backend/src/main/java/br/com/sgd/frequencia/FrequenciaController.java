...
public class FrequenciaController {
 ...
 @PostMapping @ResponseStatus(HttpStatus.CREATED) public EncontroResponse criar(@AuthenticationPrincipal User u,@Valid @RequestBody EncontroRequest r){return EncontroResponse.of(encontros.criar(u,r.discipuladoId(),r.data(),r.situacao()));}
 @PatchMapping("/{id}") public EncontroResponse atualizar(@AuthenticationPrincipal User u,@PathVariable long id,@Valid @RequestBody AtualizarEncontroRequest r){return EncontroResponse.of(encontros.atualizar(u,id,r.data(),r.situacao()));}
