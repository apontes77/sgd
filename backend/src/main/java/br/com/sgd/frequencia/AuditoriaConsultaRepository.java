...
public interface AuditoriaConsultaRepository extends JpaRepository<AuditLog,Long> {
 ...
 interface LinhaAuditoria { Long getId(); Long getUsuarioId(); java.time.temporal.TemporalAccessor getDataHora(); String getEntidade(); String getAcao(); String getDetalhes(); }
}
