...
public class Encontro {
    ...
    public Encontro(Discipulado discipulado, LocalDate data, SituacaoEncontro situacao, Instant agora) {
        ...
        this.discipulado = discipulado; this.data = data; this.situacao = situacao; this.criadoEm = agora; this.atualizadoEm = agora;
    }
    public void atualizar(LocalDate data, SituacaoEncontro situacao, Instant agora) { if (data != null) this.data = data; if (situacao != null) this.situacao = situacao; this.atualizadoEm = agora; }
    public Long getId() { return id; } public Discipulado getDiscipulado() { return discipulado; } public LocalDate getData() { return data; }
    public SituacaoEncontro getSituacao() { return situacao; } public Instant getCriadoEm() { return criadoEm; }
}
