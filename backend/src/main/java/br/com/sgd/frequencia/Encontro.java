...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            name = "uk_encontro_discipulado_data",
            columnNames = {"discipulado_id", "data"}))
public class Encontro {
  ...
  private SituacaoEncontro situacao;
  ...
  public Encontro(
      Discipulado discipulado, LocalDate data, SituacaoEncontro situacao, Instant agora) {
  ...
  public Encontro(
      ...
      Instant agora) {
    if (discipulado == null || data == null || situacao == null)
      throw new IllegalArgumentException("Os dados do encontro são obrigatórios.");
  ...
  public SituacaoEncontro getSituacao() {
    return situacao;
  }
